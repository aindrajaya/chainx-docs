...
<Tabs>
  ...
  <TabItem value="javascript" label="JavaScript">
    ...
    async function getUserPlan(userId) {
      const response = await fetch(
        `https://chainx-api-dev-70e077384a6e.herokuapp.com/api/v1/user-plan?userId=${userId}`
      );
  ...
  <TabItem value="python" label="Python">
    ...
    def get_user_plan(user_id):
        url = f'https://chainx-api-dev-70e077384a6e.herokuapp.com/api/v1/user-plan?userId={user_id}'
...
<Tabs>
  ...
  <TabItem value="api" label="Via API">
    ...
    curl -X POST https://chainx-api-dev-70e077384a6e.herokuapp.com/api/upgrade-plan \
      -H "X-API-Key: prod-chainx-abc123..." \
      -H "Content-Type: application/json" \
      -d '{
        "newPlan": "pro"
