...
<Tabs>
  ...
  <TabItem value="python" label="Python">
    ...
    def generate_api_key(user_id, key_type, name):
        url = 'https://chainx-api-dev-70e077384a6e.herokuapp.com/api/generate-api-key'
        payload = {
            'userId': user_id,
            'type': key_type,
            'name': name
...
<Tabs>
  <TabItem value="curl" label="cURL" default>
    ```bash
    curl -X GET "https://chainx-api-dev-70e077384a6e.herokuapp.com/api/v1/user-api-keys?userId=cluxyz123" \
      -H "Content-Type: application/json"
    ```
  </TabItem>
  <TabItem value="javascript" label="JavaScript">
    ...
    async function getApiKeys(userId) {
      const response = await fetch(`https://chainx-api-dev-70e077384a6e.herokuapp.com/api/v1/user-api-keys?userId=${userId}`);
      return response.json();
    }
  ...
  <TabItem value="python" label="Python">
    ...
    def get_api_keys(user_id):
        url = f'https://chainx-api-dev-70e077384a6e.herokuapp.com/api/v1/user-api-keys?userId={user_id}'
