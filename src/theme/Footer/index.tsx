...
function Footer(): JSX.Element | null {
  ...
  const onSubmit = (data: { email: string }) => {
    ...
    if (email) {
      fetch("https://brevo.ronald.io/", options)
        ...
        <div className="flex gap-8 flex-col lg:flex-row">
          <div className="w-full lg:w-[480px]">
            ...
            <p className="mb-0 text-black/60 dark:text-white/60">
              Subscribe to our newsletter on Blockchain security researcher.
            </p>
            <div className="mt-4">
              <form
          ...
          {links.length > 0 && (
            <div className="w-full grid lg:grid-cols-3 xl:grid-cols-5 grid-cols-2 gap-10">
